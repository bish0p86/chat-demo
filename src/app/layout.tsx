...
export const metadata: Metadata = {
    title: "Blink Chat",
    description: "An example chat application",
};

// Data should prob have a separate index array for faster lookup
// Obviously this is not a real database and would functionally be a lot different
...
export default function RootLayout({
    ...
    return (
        <ConversationProvider conversations={data}>
            <html lang="en">
